      ...
      <main className="flex-1">
        <section className="container py-20 md:py-28">
          ...
          <div className="mx-auto mt-14 max-w-5xl">
            {/* Swapped for contrast: light page → dark UI; dark page → light UI */}
            <div className="animate-hero-image overflow-hidden rounded-xl border border-border/70 bg-muted/50 shadow-[0_24px_80px_-32px_hsl(var(--foreground)/0.35)] ring-1 ring-black/5 dark:ring-white/10">
              <Image
                src="/hero-dark.png"
                alt={t("hero.title")}
                width={1200}
        ...
        <section id="contact" className="border-t border-border bg-muted/30 py-20">
          <div className="container mx-auto max-w-2xl text-center">
            <h2 className="text-h1 font-bold">{t("contact.title")}</h2>
            <p className="mt-3 text-body text-muted-foreground">
              {t("contact.subtitle")}
            </p>
